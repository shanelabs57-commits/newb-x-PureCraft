...
/* Golden Hour - Dawn / Morning */
#define NL_DAWN_ZENITH_COL   vec3(0.16,0.20,0.32)
#define NL_DAWN_HORIZON_COL  vec3(1.60,0.42,0.10)
#define NL_DAWN_EDGE_COL     vec3(2.20,0.72,0.18)

/* Golden Hour - Day */
#define NL_DAY_ZENITH_COL    vec3(0.32,0.52,0.78)
#define NL_DAY_HORIZON_COL   vec3(1.45,0.72,0.28)
#define NL_DAY_EDGE_COL      vec3(1.80,0.92,0.38)

/* Golden Hour - Night */
#define NL_NIGHT_ZENITH_COL  vec3(0.012,0.018,0.045)
#define NL_NIGHT_HORIZON_COL vec3(0.075,0.045,0.065)
#define NL_NIGHT_EDGE_COL    vec3(0.16,0.075,0.055)

/* Golden Hour - Rain */
#define NL_RAIN_ZENITH_COL   vec3(0.25,0.25,0.28)
#define NL_RAIN_HORIZON_COL  vec3(0.62,0.43,0.32)

/* End Sky */
#define NL_END_ZENITH_COL    vec3(0.08,0.001,0.10)
#define NL_END_HORIZON_COL   vec3(0.60,0.02,0.60)
...
/* Aurora Colors */
#define NL_AURORA_COL1 vec3(0.10,0.45,1.00)
#define NL_AURORA_COL2 vec3(0.35,0.05,1.00)
